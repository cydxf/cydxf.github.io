...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process audio file and convert to text")
    parser.add_argument('input_audio_file', type=str, help='Path to the input audio file')
    parser.add_argument('output_txt_file', type=str, help='Path to the output text file')

    args = parser.parse_args()

    # 音频文件转换
    output_audio_file = args.input_audio_file.replace(".wav", "_output.wav")
    convert_audio(args.input_audio_file, output_audio_file)
